...
def fig1(model,add_str=''):
    ...
    plt.savefig('replicated_fig1' +sol_gp_str + add_str + '.pdf',bbox_inches="tight")
...
def fig5(model,consumption,income,add_str=''):
    ...
    plt.savefig('replicated_fig5' +sol_gp_str + add_str + '.pdf',bbox_inches="tight")
...
def fig7_higher_r(par_vec=[],par_list=(),add_str=''):
    ...
    plt.savefig('replicated_fig7' + add_str + '_highR' + '.pdf',bbox_inches="tight")
...
def fig7(par_vec=[],par_list=(),add_str=''):
    ...
    plt.savefig('replicated_fig7' + add_str + '.pdf',bbox_inches="tight")
    ...
    plt.savefig('replicated_fig7_bottom' + add_str + '.pdf',bbox_inches="tight")
...
def fig7_old(model,par_vec=[],par_list=(),add_str='',do_higher_r=False):
    ...
    plt.savefig('replicated_fig7' +sol_gp_str + add_str + '.pdf',bbox_inches="tight")
    ...
    plt.savefig('replicated_fig7_bottom' + sol_gp_str + add_str + '.pdf',bbox_inches="tight")
...
def cali(model,add_str=''):
    ...
    plt.savefig('replicated_cali' +sol_gp_str + add_str + '.pdf',bbox_inches="tight")
...
def sens_fig_tab(sens,sense,theta,est_par_tex,fixed_par_tex,sol_gp=False,add_str=''):
    ...
    plt.savefig('sense_' + name + '.pdf',bbox_inches="tight")