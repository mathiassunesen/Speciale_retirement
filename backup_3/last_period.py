...
@njit(parallel=True)
def solve_c(t,ad,st_h,st_w,ra_h,ra_w,d_h,d_w,sol,par):
    ...
    c = sol.c[t,ad_idx,st_h,st_w,ra_h,ra_w,d,:]
    m = sol.m[t,ad_idx,st_h,st_w,ra_h,ra_w,d,:]
    v = sol.v[t,ad_idx,st_h,st_w,ra_h,ra_w,d,:]
